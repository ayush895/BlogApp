...
const debouncedValidateUsername = debounce((value) => {
 const errors = validators.username.validate(value);
...
document.getElementById("username").addEventListener("input", function () {
 debouncedValidateUsername(this.value);
});


document.getElementById("username").addEventListener("blur", function () {
 const errors = validators.username.validate(this.value);
 displayErrors("username", errors);
});
...
form.addEventListener("submit", function (e) {
 ...
 const usernameErrors = validators.username.validate(username);
...
// Revised Code with "full_name" instead of "username"
...
//       }
//       // No other validations for full name - just required check
